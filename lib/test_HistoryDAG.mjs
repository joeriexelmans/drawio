...
import { HistoryItem, HistoryDAG, isAncestor, isAncestor2, findLCAs, findConcurrentItems } from "./HistoryDAG.mjs";

{
  ...
  function runTest() {
...

    {
      ...
      {
        let i=0;
        for (const item of findConcurrentItems(c, d)) {
...

      {
        ...
        function resolve(item1, item2) {
          ...
          trace.push({event:'conflict', winner: winner.value.tag});
          return winner;
        }
